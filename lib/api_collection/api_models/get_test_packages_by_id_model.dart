...
//
//     final getTestPackagesByIdModel = getTestPackagesByIdModelFromJson(jsonString);

import 'dart:convert';

GetTestPackagesByIdModel getTestPackagesByIdModelFromJson(String str) =>
    GetTestPackagesByIdModel.fromJson(json.decode(str));

String getTestPackagesByIdModelToJson(GetTestPackagesByIdModel data) =>
    json.encode(data.toJson());

class GetTestPackagesByIdModel {
  bool? status;
  TestPackage? testPackage;

  GetTestPackagesByIdModel({
    this.status,
    this.testPackage,
  });

  factory GetTestPackagesByIdModel.fromJson(Map<String, dynamic> json) =>
      GetTestPackagesByIdModel(
        status: json["status"] ?? false,
        testPackage: json["testPackage"] == null
            ? null
            : TestPackage.fromJson(json["testPackage"]),
      );

  Map<String, dynamic> toJson() => {
        "status": status,
        "testPackage": testPackage?.toJson(),
      };
}
